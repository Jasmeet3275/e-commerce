...
// Empty/whitespace-only/overlong search terms fall back to "" (no search)
// rather than erroring — same reasoning as productsPageParamSchema.
export const productsSearchParamSchema = z.string().trim().max(100).catch("");
